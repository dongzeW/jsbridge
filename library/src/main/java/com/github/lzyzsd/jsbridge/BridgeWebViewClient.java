...
class BridgeWebViewClient extends WebViewClient {
  ...
  @Nullable @Override public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
    if (mClient != null) {
  ...
  @Override public void onTooManyRedirects(WebView view, android.os.Message cancelMsg,
  ...
  @Override public void onFormResubmission(WebView view, android.os.Message dontResend,
  ...
  @Override public void onReceivedLoginRequest(WebView view, String realm, @Nullable String account,
      String args) {
    if (mClient != null) {
  ...
  @Override public void onSafeBrowsingHit(WebView view, WebResourceRequest request, int threatType,

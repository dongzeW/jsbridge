...
@SuppressLint("SetJavaScriptEnabled") public class BridgeWebView extends WebView
    implements WebViewJavascriptBridge, BridgeWebViewClient.OnLoadJSListener {
  ...
  @Override public void sendToWeb(Object data) {
    sendToWeb(data, (OnBridgeCallback) null);
  }

  @Override public void sendToWeb(Object data, OnBridgeCallback responseCallback) {
  ...
  @Override public void sendToWeb(String function, Object... values) {
  ...
  private void doSend(String handlerName, Object data, OnBridgeCallback responseCallback) {
    ...
    if (responseCallback != null) {
      String callbackId = String.format(BridgeUtil.CALLBACK_ID_FORMAT,
  ...
  public static abstract class BaseJavascriptInterface {
     ...
     * @return 直接带返回值的方法
     */
    @JavascriptInterface public String send(String data, String callbackId) {
      Log.d("chromium",
          data + ", callbackId: " + callbackId + " " + Thread.currentThread().getName());
      return sendImpl(data, callbackId);
    }

    @JavascriptInterface public void response(String data, String responseId) {
      Log.d("chromium",
     ...
     */
    public abstract String sendImpl(String data, String webResponseId);
  }
}
